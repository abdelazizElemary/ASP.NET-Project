<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/MasterPage.master" AutoEventWireup="true" CodeFile="UpdatePage.aspx.cs" Inherits="Pages_UpdatePage" %>

<asp:Content ID="Content1" ContentPlaceHolderID="mainContent" Runat="Server">

    <link href="../CSS/Gridstyle.css" rel="stylesheet" />
     
    <div class="wow fadeIn productlist" id="second" runat="server">
        <asp:Button class="wow bounce button" ID="updateList_btn" runat="server" Text="View Update List" OnClick="updateList_btn_Click" />
        <asp:Button class="wow bounce button" ID="home_btn" runat="server" Text="Return Home" Width="296px" OnClick="home_btn_Click1" />
        <br />
        <br />
        &nbsp;
        </div>
      <div class="wow slideInLeft productlist" id="addlist" runat="server" visible="false">
        <asp:Button class="wow bounce button" ID="hide_btn" runat="server" Text="Hide Update List" OnClick="hide_btn_Click" />
